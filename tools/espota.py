...
#
#
# Shipped unmodified with the CH32H41x Arduino core. The protocol is the
# ESP's and the core speaks it, so nothing here needed changing -- but note
# WHICH FILE TO SEND: firmware_ota.bin, not firmware.bin. The full binary
# starts with the V3F boot stub, and the sketch it carries is 32 KB further
# in; the board's Updater rejects it, but sending the right one is better than
# being told off for sending the wrong one.
#
