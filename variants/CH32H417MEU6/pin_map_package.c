/* Peripheral pin maps for the CH32H417MEU6. GENERATED -- see tools/genvariants.py.
 *
 ...
 * can actually perform: the pins must be bonded on the QFN88 package, and
