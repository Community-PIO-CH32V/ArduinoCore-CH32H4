/* CH32H417MEU6 in the QFN88 package: the pins the silicon has.
 *
...
#define CH32H4_PACKAGE_ID   0x4171050D   /* the word at 0x1FFFF704, masked & ~0xF0 */
#define CH32H4_PINS_BONDED  65   /* of 96 pin numbers */
