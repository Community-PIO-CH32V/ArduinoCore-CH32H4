/* The pin table for the CH32H416RDU6. GENERATED -- see tools/genvariants.py.
 *
...
/* Which pins the QFN60 package actually bonds out, one bit per pin number.
 *
...
const uint32_t g_pin_bonded[3] = { 0x03FBF8FF, 0x060C1FFF, 0x37C08200 };
