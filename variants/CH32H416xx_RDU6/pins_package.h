/* CH32H416RDU6 in the QFN60 package: the pins the silicon has.
 *
...
#define CH32H4_PACKAGE_ID   0x4160050D   /* the word at 0x1FFFF704, masked & ~0xF0 */
#define CH32H4_PINS_BONDED  48   /* of 96 pin numbers */
