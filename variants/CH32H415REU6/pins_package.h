/* CH32H415REU6 in the QFN60 package: the pins the silicon has.
 *
...
#define CH32H4_PACKAGE_ID   0x4150050D   /* the word at 0x1FFFF704, masked & ~0xF0 */
#define CH32H4_PINS_BONDED  54   /* of 96 pin numbers */
...
#define A4   PC4   /* ADC_IN14 */
/* A5   PC5   is not bonded on this package */
#define A6   PA0   /* ADC_IN0 */
#define A7   PA1   /* ADC_IN1 */
#define A8   PA2   /* ADC_IN2 */
#define A9   PA3   /* ADC_IN3 */
#define A10  PA4   /* ADC_IN4 */
#define A11  PA5   /* ADC_IN5 */
#define A12  PA6   /* ADC_IN6 */
#define A13  PA7   /* ADC_IN7 */
...
#define CH32H4_HAS_SDIO     1
#define CH32H4_HAS_SWPMI    1
#define CH32H4_HAS_USBFS    1
#define CH32H4_HAS_USBHS    1
#define CH32H4_HAS_USBPD    1

/* This part has no VIO18 or VDDIO rail, so there is only one I/O
