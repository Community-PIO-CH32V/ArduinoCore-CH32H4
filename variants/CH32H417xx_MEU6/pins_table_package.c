/* The pin table for the CH32H417MEU6. GENERATED -- see tools/genvariants.py.
 *
...
/* Which pins the QFN88 package actually bonds out, one bit per pin number.
 *
...
const uint32_t g_pin_bonded[3] = { 0x7F1BFE31, 0xFCFF1FCF, 0x403FFC7B };
