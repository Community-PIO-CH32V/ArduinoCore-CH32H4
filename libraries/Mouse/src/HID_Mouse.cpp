...
#include "HID_Mouse.h"
/* RP2040USB.h was here: arduino-pico's own USB layer, which supplied the
   report IDs and the mutex for the transport it implemented in this file.
   That transport is #if 0 in this copy -- the CH32H41x one is in
   Keyboard.cpp / Mouse.cpp, over Adafruit_USBD_HID -- so the include went
   with it. */
