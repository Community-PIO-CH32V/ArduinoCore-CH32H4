...
HTTPServer::ClientFuture HTTPServer::_parseRequest(Client* client) {
...
int HTTPServer::_uploadReadByte(Client * client) {
    int res = client->read();
...
bool HTTPServer::_parseForm(Client * client, String boundary, uint32_t len) {
    (void)len;
